...
int main(int argc, char *argv[]){
  ...
  if (argc != 4){
    cerr << "" << endl;
    cerr << "+--------------------------------------------------------------------------------------------------------------------------------+" << endl;
    cerr << "+ Usage	         : ./chrono [main_file] [exec_file] [time_limit]" << endl;
    cerr << "+--------------------------------------------------------------------------------------------------------------------------------+" << endl;
    cerr << "+ Purpose        : generates a C source file called exec_file that runs the main function in main_file" << endl;
    cerr << "+                  and prints \"timeout\\n\" to stderr & exits with a non-zero exit code if it doesn't finish within the time_limit" << endl;
    cerr << "+                  and prints nothing and exits with exit code zero otherwise" << endl;
    cerr << "+--------------------------------------------------------------------------------------------------------------------------------+" << endl;
    ...
    cerr << "+ [time_limit]   : the amount of time the exec_file has to complete its execution (in time_t unit)" << endl;
    cerr << "+--------------------------------------------------------------------------------------------------------------------------------+" << endl;
  ...
  string setup = setup_1 + measure_start;
  first += setup;
